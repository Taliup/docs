...
Vous activez les Cartes-cadeaux **un emplacement à la fois**, sous forme de module mensuel. Chaque emplacement activé obtient sa propre configuration chez Factor4.
...
L'annulation est différée. À la fin de la période de facturation, l'emplacement est suspendu chez Factor4 et les cartes-cadeaux cessent d'y fonctionner. Les cartes déjà entre les mains des clients conservent leur solde chez Factor4, mais vos terminaux ne peuvent plus les encaisser.
