...
| **Points** | Le solde à la dernière fois où il a été gagné, échangé ou consulté |
...
<Warning>
  Des points gagnés puis dépensés ne peuvent pas être annulés, car un solde ne peut jamais être négatif. Si une commande est remboursée après que ses points ont été échangés, ajustez le membre manuellement avec le soutien.
</Warning>
