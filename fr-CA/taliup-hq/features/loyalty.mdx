...
Ouvrez **Paramètres > Fidélité** dans la barre latérale marchand.
...
<Steps>
  <Step title="Fidélité offerte dans votre plan">
    Votre admin ISO active **Fidélité** dans le plan de l'entité. Si vous ne voyez pas **Fidélité** sous **Paramètres**, demandez-lui de l'ajouter dans [Plans et fonctionnalités](/fr-CA/taliup-hq/onboarding/plans-features).
  </Step>
...
### Fidélité n'est pas sous Paramètres
