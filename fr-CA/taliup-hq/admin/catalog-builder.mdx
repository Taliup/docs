...
Cliquez sur un article pour ouvrir son éditeur. Vous pouvez changer le nom, la description, le prix, le SKU, le coût, le fournisseur, la majoration, le type, les taxes, l'étiquette, les attributs et l'URL de l'image.
...
Cochez des articles pour faire apparaître la barre d'actions groupées : réglez l'action sur tous, ajoutez une taxe, déplacez-les vers une autre catégorie, passez-les en prix personnalisé ou ignorez-les. Le menu à côté de **Commit** applique **Link all confident matches** ou **Create all as new** à toute l'ébauche.
...
Les photos d'articles importées sont stockées à 1 200 pixels de large au maximum. `CATALOG_BUILDER_IMAGE_MAX_WIDTH` modifie cette limite.
