...
| **Industries** | Optional. Check one or more to restrict this plan to specific merchant industries (Restaurant, Retail/Wholesale). Leave all unchecked to make the plan available to all industries. |
