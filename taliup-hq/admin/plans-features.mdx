...
| End of Day Report | Merchant daily documentation report on POS and in Taliup HQ. |
...
| Recurring Payments | Scheduled customer payments with a hosted checkout link. Requires Hosted Payment Solution and Clients. |
