...
<Steps>
  <Step title="Gift Cards available on your plan">
    Your ISO admin enables **Gift Cards** on the entity plan. If you do not see **Gift Cards** in the sidebar, ask them to add it in [Plans & Features](/taliup-hq/admin/plans-features).
  </Step>
  <Step title="At least one terminal on the location">
    A location needs a registered terminal before it can be activated. The terminal is registered with Factor4 during setup so it can run gift card transactions. See [Terminals](/taliup-hq/onboarding/terminals).
  </Step>
...
- [Plans & Features](/taliup-hq/admin/plans-features)
