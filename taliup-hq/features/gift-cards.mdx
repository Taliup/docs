...
You activate Gift Cards **one location at a time** as a monthly add-on. Your business has a single gift card program with Factor4: the first location you activate creates it, and every location you activate afterwards joins it.
...
Cards are shared across your business. A card sold at one active location can be redeemed, checked, or refunded at any of your other active locations. It cannot be used at another business.
...
Cancellation is deferred. At the end of the billing period, the location is suspended with Factor4 and gift cards stop working there. Cards already in customers' hands keep their balance with Factor4 and can still be redeemed at your other active locations, but the suspended location can no longer sell or redeem them.
