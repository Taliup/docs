...
If the entity industry is **Charity**, the open-amount donation page can send a tax-compliant electronic receipt (English, French, or Spanish).

Before the donation page works, complete **Charity Details** on the entity:

- **Charity / Registration Number** (required)
- **Tax ID** (optional)
- A complete registered address on the [entity profile](/taliup-hq/manage/profile)

<Frame caption="Charity Details on Settings → Business.">
  ![Harbour Light Foundation Business settings with Charity Details, registration number BN 123456789RR0001, and Tax ID](/images/taliup-hq/charity-details.png)
</Frame>
...
<Steps>
  ...
  <Step title="Select the donation">
    Click the donation to open the transaction details.
  </Step>
  <Step title="View or send the receipt">
...
- [Recurring Payments](/taliup-hq/features/recurring-payments)
