...
| **Points** | The balance as of the last time it was earned, spent, or checked |
...
<Warning>
  Points that were earned and then spent cannot be voided, because a balance can never go below zero. If an order is refunded after its points were redeemed, adjust the member manually with support.
</Warning>
