...
Open **Settings > Loyalty** in the merchant sidebar.
...
<Steps>
  <Step title="Loyalty available on your plan">
    Your ISO admin enables **Loyalty** on the entity plan. If you do not see **Loyalty** under **Settings**, ask them to add it in [Plans & Features](/taliup-hq/onboarding/plans-features).
  </Step>
