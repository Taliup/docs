...
<CardGroup cols={2}>
  <Card title="Hosted Payments" icon="credit-card" href="/quickstart">
  ...
  <Card title="Webhook Verification" icon="shield-check" href="/quickstart">
  ...
  <Card title="Typed Error Handling" icon="triangle-exclamation" href="/quickstart">
