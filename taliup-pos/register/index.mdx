...
<Frame caption="Register main screen (Open Sale or Menu/Catalog with cart).">
  ![Register main screen (Open Sale or Menu/Catalog with cart)](/images/taliup-pos/register/overview.png)
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="Scale barcodes" href="/taliup-pos/register/scale-barcodes">
    Scan a price or weight sticker from a counter scale.
  </Card>
  ...
  <Card title="Customer receipt" href="/taliup-pos/register/customer-receipt">
    Choose No Receipt, Paper, or Email after payment.
  </Card>
