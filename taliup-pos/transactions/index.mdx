...
description: "Find payments in Taliup POS and void, return (refund), reprint receipts, or run End of Day."
---

**Transactions** is where you look up completed payments and take follow-up actions such as void, return (refund), reprint, or End of Day.
...
<Frame caption="Transactions list with ID, Date/Time, and Total columns.">
  ![Transactions list with ID, Date/Time, and Total columns](/images/taliup-pos/transactions/list.png)
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="End of Day" href="/taliup-pos/transactions/end-of-day">
    Preview, generate, and print a merchant daily report for one or more devices.
  </Card>
</CardGroup>
