...
<Frame caption="Refund options — Full Refund, Partial Refund (Itemized), Partial Refund (Enter Amount).">
  ![Refund options — Full Refund, Partial Refund (Itemized), Partial Refund (Enter Amount)](/images/taliup-pos/transactions/refund-options.png)
</Frame>
...
<Frame caption="Itemized refund item picker with Select All.">
  ![Itemized refund item picker with Select All](/images/taliup-pos/transactions/refund-itemized.png)
</Frame>
