...
<Tip>
  ...
  If the merchant is still on the standalone **Taliup MEV** app, remove it and install Taliup POS first. See [Migrate from MEV](/taliup-hq/onboarding/web-srm#migrate-from-mev).
</Tip>
